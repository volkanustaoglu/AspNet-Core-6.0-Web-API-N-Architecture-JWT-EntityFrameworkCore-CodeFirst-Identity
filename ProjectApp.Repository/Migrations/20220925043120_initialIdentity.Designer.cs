...
namespace ProjectApp.Repository.Migrations
{
    ...
    [Migration("20220925043120_initialIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectApp.Core.Models.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ProjectApp.Core.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProjectApp.Core.Models.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ProjectApp.Core.Models.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjectApp.Core.Models.AppUser", null)
                        .WithMany()
